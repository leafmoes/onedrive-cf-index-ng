...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'leafmoes@r12.top',
  ...
  email: 'mailto:leafmoes@gmail.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/leafmoes',
    },
  ],
